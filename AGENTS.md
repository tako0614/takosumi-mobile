...
- Scope: Independent Tauri mobile client for Takosumi control-plane operations.
- Repository kind: `client`
- Direct sibling dependencies: `mobile-kit`, `takosumi`
- Repository gate: `bun run check`
- Canonical docs: [README.md](README.md), [src-tauri/plugins/keystore/README.md](src-tauri/plugins/keystore/README.md)
